...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ISBN', models.CharField(db_index=True, max_length=100, unique=True)),
                ('name', models.CharField(max_length=100)),
                ('category', models.CharField(db_index=True, max_length=100)),
                ('authors', models.ManyToManyField(to='librarySystem.author')),
            ],
        ),
        migrations.CreateModel(
            name='LibraryBranch',
            fields=[
                ...
                ('library', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='librarySystem.library')),
            ],
        ),
        migrations.CreateModel(
            name='BookStock',
            fields=[
                ...
                ('library_branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='librarySystem.librarybranch')),
            ],
        ),
        migrations.CreateModel(
            name='User',
            fields=[
                ...
                ('location_lat', models.FloatField(default=100.0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='librarySystem.book')),
